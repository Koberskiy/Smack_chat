...
class AuthService {
    ...
    func registerUser (email: String,
                       password: String,
                       completion: @escaping CompetionHandler) {
...
//                                }
    ...
    func createUser(name: String, email: String, avatarName: String, avatarColor: String, completion: @escaping CompetionHandler) {
    ...
    func findUserByEmail(completion: @escaping CompetionHandler) {
